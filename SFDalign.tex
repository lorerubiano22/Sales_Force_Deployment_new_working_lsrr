...
\pgfmathsetseed{1234}
  ...
  \draw[decorate,very thick] (0.8,0.6) -- (.75,.75) -- (.7,1) -- (1,1.2) -- (1.2,1.5) -- (1.1,2) -- (1,2.2) -- (.9,2.3) -- (.9,2.6) -- (1,2.8) -- (1.2,3) -- (1.5,3.2)
	...
	;
	\node[decorate,draw,circle,fill=structure.fg,inner sep=0.01cm] at (1.5,1) {\footnotesize\textcolor{white}{C}}; %
	\node[decorate,draw,circle,fill=structure.fg,inner sep=0.01cm] at (1.9,3) {\footnotesize\textcolor{white}{D}};
